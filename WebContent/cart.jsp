...
<body>
	...
	<div class="container">
		...
		<div class="d-flex py-3">
			<h3>Total Price : ${ (total>0)?total:0 } VND</h3>
			<a class="mx-3 btn btn-outline-info" href="cart-check-out">Check Out</a>
		</div>
				...
				<tr>
					...
					<td>
						<form action="order-now" method="post" class="form-inline">
							...
							<button type="submit" class="btn btn-outline-info btn-sm">Buy</button>
						</form>
					</td>
