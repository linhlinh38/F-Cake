		...
		<div class="card-header my-3">
			<ul class="nav nav-pills card-header-tabs">
				<li class="nav-item"><a class="nav-link" href="index.jsp"><b>All
							Products</b></a></li>
				<li class="nav-item"><a class="nav-link active" href="barguette.jsp">Barguette</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="sweetcake.jsp">Sweet Cake</a></li>
		...
		<div class="row">
			...
			if(!products.isEmpty()) {
				for(Product p:products) {
					if((p.getCategory()).equals("Barguette")) {%>
